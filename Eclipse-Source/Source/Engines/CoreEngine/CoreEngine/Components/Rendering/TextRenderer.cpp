...
namespace Eclipse
{
	...
	{
		myShader = new Shader();
		myShader->Create((PathManager::GetEngineAssets() / "Default/Shaders/Text.pglsl").generic_string().c_str(), (PathManager::GetEngineAssets() / "Default/Shaders/Text.vglsl").generic_string().c_str());
