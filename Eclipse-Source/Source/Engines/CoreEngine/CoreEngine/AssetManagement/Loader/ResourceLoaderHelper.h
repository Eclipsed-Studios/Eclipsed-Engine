...
namespace Eclipse
{
	...
	{
	public:
		static unsigned char* Load_Texture_STB(const char* aPath, class Texture& outResource, bool flipVertically = false);
		...
		static unsigned char* Load_Texture_From_Memory_STB(std::vector<unsigned char>& data, class Texture& outResource, bool flipVertically = false);
