...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    if (ImGui::CollapsingHeader("Configuration"))
    {
        ...
        if (ImGui::TreeNode("Configuration##2"))
        {
            ...
            ImGui::CheckboxFlags("EclipsedEngine/Assets/IO.ConfigFlags: NavEnableKeyboard",    &io.ConfigFlags, ImGuiConfigFlags_NavEnableKeyboard);
            ImGui::SameLine(); HelpMarker("Enable keyboard controls.");
            ImGui::CheckboxFlags("EclipsedEngine/Assets/IO.ConfigFlags: NavEnableGamepad",     &io.ConfigFlags, ImGuiConfigFlags_NavEnableGamepad);
            ImGui::SameLine(); HelpMarker("Enable gamepad controls. Require backend to set io.BackendFlags |= ImGuiBackendFlags_HasGamepad.\n\nRead instructions in imgui.cpp for details.");
            ImGui::CheckboxFlags("EclipsedEngine/Assets/IO.ConfigFlags: NoMouse",              &io.ConfigFlags, ImGuiConfigFlags_NoMouse);
            ...
            ImGui::CheckboxFlags("EclipsedEngine/Assets/IO.ConfigFlags: NoMouseCursorChange",  &io.ConfigFlags, ImGuiConfigFlags_NoMouseCursorChange);
            ImGui::SameLine(); HelpMarker("Instruct backend to not alter mouse cursor shape and visibility.");
            ImGui::CheckboxFlags("EclipsedEngine/Assets/IO.ConfigFlags: NoKeyboard", &io.ConfigFlags, ImGuiConfigFlags_NoKeyboard);
            ImGui::SameLine(); HelpMarker("Instruct dear imgui to disable keyboard inputs and interactions.");

            ImGui::Checkbox("EclipsedEngine/Assets/IO.ConfigInputTrickleEventQueue", &io.ConfigInputTrickleEventQueue);
            ImGui::SameLine(); HelpMarker("Enable input queue trickling: some types of events submitted during the same frame (e.g. button down + up) will be spread over multiple frames, improving interactions with low framerates.");
            ImGui::Checkbox("EclipsedEngine/Assets/IO.MouseDrawCursor", &io.MouseDrawCursor);
            ImGui::SameLine(); HelpMarker("Instruct Dear ImGui to render a mouse cursor itself. Note that a mouse cursor rendered via your application GPU rendering path will feel more laggy than hardware cursor, but will be more in sync with your other visuals.\n\nSome desktop applications may use both kinds of cursors (e.g. enable software cursor only when resizing/dragging something).");

            ImGui::SeparatorText("Keyboard/Gamepad Navigation");
            ImGui::Checkbox("EclipsedEngine/Assets/IO.ConfigNavSwapGamepadButtons", &io.ConfigNavSwapGamepadButtons);
            ImGui::Checkbox("EclipsedEngine/Assets/IO.ConfigNavMoveSetMousePos", &io.ConfigNavMoveSetMousePos);
            ...
            ImGui::Checkbox("EclipsedEngine/Assets/IO.ConfigNavCaptureKeyboard", &io.ConfigNavCaptureKeyboard);
            ImGui::Checkbox("EclipsedEngine/Assets/IO.ConfigNavEscapeClearFocusItem", &io.ConfigNavEscapeClearFocusItem);
            ImGui::SameLine(); HelpMarker("Pressing Escape clears focused item.");
            ImGui::Checkbox("EclipsedEngine/Assets/IO.ConfigNavEscapeClearFocusWindow", &io.ConfigNavEscapeClearFocusWindow);
            ImGui::SameLine(); HelpMarker("Pressing Escape clears focused window.");
            ImGui::Checkbox("EclipsedEngine/Assets/IO.ConfigNavCursorVisibleAuto", &io.ConfigNavCursorVisibleAuto);
            ImGui::SameLine(); HelpMarker("Using directional navigation key makes the cursor visible. Mouse click hides the cursor.");
            ImGui::Checkbox("EclipsedEngine/Assets/IO.ConfigNavCursorVisibleAlways", &io.ConfigNavCursorVisibleAlways);
            ImGui::SameLine(); HelpMarker("Navigation cursor is always visible.");

            ImGui::SeparatorText("Docking");
            ImGui::CheckboxFlags("EclipsedEngine/Assets/IO.ConfigFlags: DockingEnable", &io.ConfigFlags, ImGuiConfigFlags_DockingEnable);
            ImGui::SameLine();
            ...
            {
                ImGui::Indent();
                ImGui::Checkbox("EclipsedEngine/Assets/IO.ConfigDockingNoSplit", &io.ConfigDockingNoSplit);
                ImGui::SameLine(); HelpMarker("Simplified docking mode: disable window splitting, so docking is limited to merging multiple windows together into tab-bars.");
                ImGui::Checkbox("EclipsedEngine/Assets/IO.ConfigDockingNoDockingOver", &io.ConfigDockingNoDockingOver);
                ...
                ImGui::Checkbox("EclipsedEngine/Assets/IO.ConfigDockingWithShift", &io.ConfigDockingWithShift);
                ImGui::SameLine(); HelpMarker("Enable docking when holding Shift only (allow to drop in wider space, reduce visual noise)");
                ImGui::Checkbox("EclipsedEngine/Assets/IO.ConfigDockingAlwaysTabBar", &io.ConfigDockingAlwaysTabBar);
                ImGui::SameLine(); HelpMarker("Create a docking node and tab-bar on single floating windows.");
                ImGui::Checkbox("EclipsedEngine/Assets/IO.ConfigDockingTransparentPayload", &io.ConfigDockingTransparentPayload);
            ...
            ImGui::CheckboxFlags("EclipsedEngine/Assets/IO.ConfigFlags: ViewportsEnable", &io.ConfigFlags, ImGuiConfigFlags_ViewportsEnable);
            ImGui::SameLine(); HelpMarker("[beta] Enable beta multi-viewports support. See ImGuiPlatformIO for details.");
            if (io.ConfigFlags & ImGuiConfigFlags_ViewportsEnable)
            {
                ImGui::Indent();
                ImGui::Checkbox("EclipsedEngine/Assets/IO.ConfigViewportsNoAutoMerge", &io.ConfigViewportsNoAutoMerge);
                ImGui::SameLine(); HelpMarker("Set to make all floating imgui windows always create their own viewport. Otherwise, they are merged into the main host viewports when overlapping it.");
                ImGui::Checkbox("EclipsedEngine/Assets/IO.ConfigViewportsNoTaskBarIcon", &io.ConfigViewportsNoTaskBarIcon);
                ...
                ImGui::Checkbox("EclipsedEngine/Assets/IO.ConfigViewportsNoDecoration", &io.ConfigViewportsNoDecoration);
                ImGui::SameLine(); HelpMarker("(note: some platform backends may not reflect a change of this value for existing viewports, and may need the viewport to be recreated)");
                ImGui::Checkbox("EclipsedEngine/Assets/IO.ConfigViewportsNoDefaultParent", &io.ConfigViewportsNoDefaultParent);
                ImGui::SameLine(); HelpMarker("(note: some platform backends may not reflect a change of this value for existing viewports, and may need the viewport to be recreated)");
                ImGui::Checkbox("EclipsedEngine/Assets/IO.ConfigViewportsPlatformFocusSetsImGuiFocus", &io.ConfigViewportsPlatformFocusSetsImGuiFocus);
            ...
            //ImGui::Checkbox("EclipsedEngine/Assets/IO.ConfigDpiScaleFonts", &io.ConfigDpiScaleFonts);
            ...
            //ImGui::Checkbox("EclipsedEngine/Assets/IO.ConfigDpiScaleViewports", &io.ConfigDpiScaleViewports);
            //ImGui::SameLine(); HelpMarker("Experimental: Scale Dear ImGui and Platform Windows when Monitor DPI changes.");

            ImGui::SeparatorText("Windows");
            ImGui::Checkbox("EclipsedEngine/Assets/IO.ConfigWindowsResizeFromEdges", &io.ConfigWindowsResizeFromEdges);
            ImGui::SameLine(); HelpMarker("Enable resizing of windows from their edges and from the lower-left corner.\nThis requires ImGuiBackendFlags_HasMouseCursors for better mouse cursor feedback.");
            ImGui::Checkbox("EclipsedEngine/Assets/IO.ConfigWindowsMoveFromTitleBarOnly", &io.ConfigWindowsMoveFromTitleBarOnly);
            ImGui::Checkbox("EclipsedEngine/Assets/IO.ConfigWindowsCopyContentsWithCtrlC", &io.ConfigWindowsCopyContentsWithCtrlC); // [EXPERIMENTAL]
            ...
            ImGui::Checkbox("EclipsedEngine/Assets/IO.ConfigScrollbarScrollByPage", &io.ConfigScrollbarScrollByPage);
            ImGui::SameLine(); HelpMarker("Enable scrolling page by page when clicking outside the scrollbar grab.\nWhen disabled, always scroll to clicked location.\nWhen enabled, Shift+Click scrolls to clicked location.");

            ImGui::SeparatorText("Widgets");
            ImGui::Checkbox("EclipsedEngine/Assets/IO.ConfigInputTextCursorBlink", &io.ConfigInputTextCursorBlink);
            ImGui::SameLine(); HelpMarker("Enable blinking cursor (optional as some users consider it to be distracting).");
            ImGui::Checkbox("EclipsedEngine/Assets/IO.ConfigInputTextEnterKeepActive", &io.ConfigInputTextEnterKeepActive);
            ImGui::SameLine(); HelpMarker("Pressing Enter will keep item active and select contents (single-line only).");
            ImGui::Checkbox("EclipsedEngine/Assets/IO.ConfigDragClickToInputText", &io.ConfigDragClickToInputText);
            ImGui::SameLine(); HelpMarker("Enable turning DragXXX widgets into text input with a simple mouse click-release (without moving).");
            ImGui::Checkbox("EclipsedEngine/Assets/IO.ConfigMacOSXBehaviors", &io.ConfigMacOSXBehaviors);
            ...
            ImGui::Checkbox("EclipsedEngine/Assets/IO.ConfigErrorRecovery", &io.ConfigErrorRecovery);
            ...
            ImGui::Checkbox("EclipsedEngine/Assets/IO.ConfigErrorRecoveryEnableAssert", &io.ConfigErrorRecoveryEnableAssert);
            ImGui::Checkbox("EclipsedEngine/Assets/IO.ConfigErrorRecoveryEnableDebugLog", &io.ConfigErrorRecoveryEnableDebugLog);
            ImGui::Checkbox("EclipsedEngine/Assets/IO.ConfigErrorRecoveryEnableTooltip", &io.ConfigErrorRecoveryEnableTooltip);
            ...
            ImGui::Checkbox("EclipsedEngine/Assets/IO.ConfigDebugIsDebuggerPresent", &io.ConfigDebugIsDebuggerPresent);
            ImGui::SameLine(); HelpMarker("Enable various tools calling IM_DEBUG_BREAK().\n\nRequires a debugger being attached, otherwise IM_DEBUG_BREAK() options will appear to crash your application.");
            ImGui::Checkbox("EclipsedEngine/Assets/IO.ConfigDebugHighlightIdConflicts", &io.ConfigDebugHighlightIdConflicts);
            ImGui::SameLine(); HelpMarker("Highlight and show an error message when multiple items have conflicting identifiers.");
            ImGui::BeginDisabled();
            ImGui::Checkbox("EclipsedEngine/Assets/IO.ConfigDebugBeginReturnValueOnce", &io.ConfigDebugBeginReturnValueOnce);
            ImGui::EndDisabled();
            ImGui::SameLine(); HelpMarker("First calls to Begin()/BeginChild() will return false.\n\nTHIS OPTION IS DISABLED because it needs to be set at application boot-time to make sense. Showing the disabled option is a way to make this feature easier to discover.");
            ImGui::Checkbox("EclipsedEngine/Assets/IO.ConfigDebugBeginReturnValueLoop", &io.ConfigDebugBeginReturnValueLoop);
            ImGui::SameLine(); HelpMarker("Some calls to Begin()/BeginChild() will return false.\n\nWill cycle through window depths then repeat. Windows should be flickering while running.");
            ImGui::Checkbox("EclipsedEngine/Assets/IO.ConfigDebugIgnoreFocusLoss", &io.ConfigDebugIgnoreFocusLoss);
            ...
            ImGui::Checkbox("EclipsedEngine/Assets/IO.ConfigDebugIniSettings", &io.ConfigDebugIniSettings);
        ...
        if (ImGui::TreeNode("Backend Flags"))
        {
            ...
            ImGui::BeginDisabled();
            ImGui::CheckboxFlags("EclipsedEngine/Assets/IO.BackendFlags: HasGamepad",             &io.BackendFlags, ImGuiBackendFlags_HasGamepad);
            ImGui::CheckboxFlags("EclipsedEngine/Assets/IO.BackendFlags: HasMouseCursors",        &io.BackendFlags, ImGuiBackendFlags_HasMouseCursors);
            ImGui::CheckboxFlags("EclipsedEngine/Assets/IO.BackendFlags: HasSetMousePos",         &io.BackendFlags, ImGuiBackendFlags_HasSetMousePos);
            ImGui::CheckboxFlags("EclipsedEngine/Assets/IO.BackendFlags: PlatformHasViewports",   &io.BackendFlags, ImGuiBackendFlags_PlatformHasViewports);
            ImGui::CheckboxFlags("EclipsedEngine/Assets/IO.BackendFlags: HasMouseHoveredViewport",&io.BackendFlags, ImGuiBackendFlags_HasMouseHoveredViewport);
            ImGui::CheckboxFlags("EclipsedEngine/Assets/IO.BackendFlags: HasParentViewport",      &io.BackendFlags, ImGuiBackendFlags_HasParentViewport);
            ImGui::CheckboxFlags("EclipsedEngine/Assets/IO.BackendFlags: RendererHasVtxOffset",   &io.BackendFlags, ImGuiBackendFlags_RendererHasVtxOffset);
            ImGui::CheckboxFlags("EclipsedEngine/Assets/IO.BackendFlags: RendererHasTextures",    &io.BackendFlags, ImGuiBackendFlags_RendererHasTextures);
            ImGui::CheckboxFlags("EclipsedEngine/Assets/IO.BackendFlags: RendererHasViewports",   &io.BackendFlags, ImGuiBackendFlags_RendererHasViewports);
            ImGui::EndDisabled();
...
static void DemoWindowInputs()
{
    ...
    if (ImGui::CollapsingHeader("Inputs & Focus"))
    {
        ...
        if (outputs_opened)
        {
            ImGui::Text("EclipsedEngine/Assets/IO.WantCaptureMouse: %d", io.WantCaptureMouse);
            ImGui::Text("EclipsedEngine/Assets/IO.WantCaptureMouseUnlessPopupClose: %d", io.WantCaptureMouseUnlessPopupClose);
            ImGui::Text("EclipsedEngine/Assets/IO.WantCaptureKeyboard: %d", io.WantCaptureKeyboard);
            ImGui::Text("EclipsedEngine/Assets/IO.WantTextInput: %d", io.WantTextInput);
            ImGui::Text("EclipsedEngine/Assets/IO.WantSetMousePos: %d", io.WantSetMousePos);
            ImGui::Text("EclipsedEngine/Assets/IO.NavActive: %d, io.NavVisible: %d", io.NavActive, io.NavVisible);
        ...
        if (ImGui::TreeNode("Dragging"))
        {
            ...
            ImGui::Text("EclipsedEngine/Assets/IO.MouseDelta: (%.1f, %.1f)", mouse_delta.x, mouse_delta.y);
            ImGui::TreePop();
        }
    }
}
...
void ImGui::ShowAboutWindow(bool* p_open)
{
    ...
    if (show_config_info)
    {
        ...
        ImGui::Separator();
        ImGui::Text("EclipsedEngine/Assets/IO.BackendPlatformName: %s", io.BackendPlatformName ? io.BackendPlatformName : "NULL");
        ImGui::Text("EclipsedEngine/Assets/IO.BackendRendererName: %s", io.BackendRendererName ? io.BackendRendererName : "NULL");
        ImGui::Text("EclipsedEngine/Assets/IO.ConfigFlags: 0x%08X", io.ConfigFlags);
        ...
        if (io.MouseDrawCursor)                                         ImGui::Text("EclipsedEngine/Assets/IO.MouseDrawCursor");
        if (io.ConfigDpiScaleFonts)                                     ImGui::Text("EclipsedEngine/Assets/IO.ConfigDpiScaleFonts");
        if (io.ConfigDpiScaleViewports)                                 ImGui::Text("EclipsedEngine/Assets/IO.ConfigDpiScaleViewports");
        if (io.ConfigViewportsNoAutoMerge)                              ImGui::Text("EclipsedEngine/Assets/IO.ConfigViewportsNoAutoMerge");
        if (io.ConfigViewportsNoTaskBarIcon)                            ImGui::Text("EclipsedEngine/Assets/IO.ConfigViewportsNoTaskBarIcon");
        if (io.ConfigViewportsNoDecoration)                             ImGui::Text("EclipsedEngine/Assets/IO.ConfigViewportsNoDecoration");
        if (io.ConfigViewportsNoDefaultParent)                          ImGui::Text("EclipsedEngine/Assets/IO.ConfigViewportsNoDefaultParent");
        if (io.ConfigDockingNoSplit)                                    ImGui::Text("EclipsedEngine/Assets/IO.ConfigDockingNoSplit");
        if (io.ConfigDockingNoDockingOver)                              ImGui::Text("EclipsedEngine/Assets/IO.ConfigDockingNoDockingOver");
        if (io.ConfigDockingWithShift)                                  ImGui::Text("EclipsedEngine/Assets/IO.ConfigDockingWithShift");
        if (io.ConfigDockingAlwaysTabBar)                               ImGui::Text("EclipsedEngine/Assets/IO.ConfigDockingAlwaysTabBar");
        if (io.ConfigDockingTransparentPayload)                         ImGui::Text("EclipsedEngine/Assets/IO.ConfigDockingTransparentPayload");
        if (io.ConfigMacOSXBehaviors)                                   ImGui::Text("EclipsedEngine/Assets/IO.ConfigMacOSXBehaviors");
        if (io.ConfigNavMoveSetMousePos)                                ImGui::Text("EclipsedEngine/Assets/IO.ConfigNavMoveSetMousePos");
        if (io.ConfigNavCaptureKeyboard)                                ImGui::Text("EclipsedEngine/Assets/IO.ConfigNavCaptureKeyboard");
        if (io.ConfigInputTextCursorBlink)                              ImGui::Text("EclipsedEngine/Assets/IO.ConfigInputTextCursorBlink");
        if (io.ConfigWindowsResizeFromEdges)                            ImGui::Text("EclipsedEngine/Assets/IO.ConfigWindowsResizeFromEdges");
        if (io.ConfigWindowsMoveFromTitleBarOnly)                       ImGui::Text("EclipsedEngine/Assets/IO.ConfigWindowsMoveFromTitleBarOnly");
        if (io.ConfigMemoryCompactTimer >= 0.0f)                        ImGui::Text("EclipsedEngine/Assets/IO.ConfigMemoryCompactTimer = %.1f", io.ConfigMemoryCompactTimer);
        ImGui::Text("EclipsedEngine/Assets/IO.BackendFlags: 0x%08X", io.BackendFlags);
        ...
        ImGui::Separator();
        ImGui::Text("EclipsedEngine/Assets/IO.Fonts: %d fonts, Flags: 0x%08X, TexSize: %d,%d", io.Fonts->Fonts.Size, io.Fonts->Flags, io.Fonts->TexData->Width, io.Fonts->TexData->Height);
        ImGui::Text("EclipsedEngine/Assets/IO.Fonts->FontLoaderName: %s", io.Fonts->FontLoaderName ? io.Fonts->FontLoaderName : "NULL");
        ImGui::Text("EclipsedEngine/Assets/IO.DisplaySize: %.2f,%.2f", io.DisplaySize.x, io.DisplaySize.y);
        ImGui::Text("EclipsedEngine/Assets/IO.DisplayFramebufferScale: %.2f,%.2f", io.DisplayFramebufferScale.x, io.DisplayFramebufferScale.y);
        ImGui::Separator();
