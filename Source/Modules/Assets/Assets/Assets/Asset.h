...
namespace Eclipse::Assets
{
	...
	//template struct ASSET_API Asset<AudioData>;
	//template struct ASSET_API Asset<FontData>;
	//template struct ASSET_API Asset<MaterialData>;
	//template struct ASSET_API Asset<PrefabData>;
	//template struct ASSET_API Asset<SceneData>;
	//template struct ASSET_API Asset<ShaderData>;
	//template struct ASSET_API Asset<TextureData>;
}