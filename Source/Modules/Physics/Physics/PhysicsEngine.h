...
namespace Eclipse
{
    ...
    private:
        ...
        static b2WorldId myWorld;
        static Math::Vector2f myGravity;
        static int mySubstepCount ;

        static b2DebugDraw myDebugDraw;
        static bool myDrawDebugShapes ;
        static bool myDrawQueries ;

        static bool myHasCreatedWorld;
    };
}