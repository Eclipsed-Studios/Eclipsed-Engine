...
namespace ENGINE_NAMESPACE
{
    ...
    public:
        ...
        static void CreateRigidBody(b2BodyId* aBody, const RigidBodySettings& aBodySettings, const Math::Vector2f& aStartPosition = { 0.f, 0.f });
        static void CreateBoxCollider(b2ShapeId* aShape, UserData* aUserData, const b2BodyId& aBodyID, const Math::Vector2f& aHalfExtents, Layer aLayer);
