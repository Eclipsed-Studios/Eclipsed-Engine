...
#include "EclipsedEngine/Core/Math/Vector/Vector3.h"
#include "EclipsedEngine/Core/Math/Vector/Vector4.h"
...
namespace Eclipse::Graphics
{
    ...
    public:
        ...
        virtual void SetUniformFloat(const char* aUniformName, unsigned aShaderProgram, const float* aValue) const = 0;

        virtual void SetUniformVec2Float(const char* aUniformName, unsigned aShaderProgram, const Math::Vector2f* aValue) const = 0;
        virtual void SetUniformVec3Float(const char* aUniformName, unsigned aShaderProgram, const Math::Vector3f* aValue) const = 0;
        virtual void SetUniformVec4Float(const char* aUniformName, unsigned aShaderProgram, const Math::Vector4f* aValue) const = 0;

        virtual void SetUniformMat2x2(const char* aUniformName, unsigned aShaderProgram, const float* aValue) const = 0;
        virtual void SetUniformMat3x3(const char* aUniformName, unsigned aShaderProgram, const float* aValue) const = 0;
        virtual void SetUniformMat4x4(const char* aUniformName, unsigned aShaderProgram, const float* aValue) const = 0;
