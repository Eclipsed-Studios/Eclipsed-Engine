...
#include "EclipsedEngine/Core/Math/Matrix/Matrix3x3.h"
...
namespace Eclipse
{
	...
	private:
		SERIALIZED_FIELD_DEFAULT(Math::Vector2f, position, Math::Vector2f(0.f, 0.f));
		SERIALIZED_FIELD_DEFAULT(Math::Vector2f, scale, Math::Vector2f(0.f, 0.f));
		SERIALIZED_FIELD_DEFAULT(float, rotation, 0.f);
