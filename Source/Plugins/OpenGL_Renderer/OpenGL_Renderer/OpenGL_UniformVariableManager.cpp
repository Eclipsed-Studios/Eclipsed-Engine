...
{
	void OpenGL_UniformVariableManager::SetGlobalUniforms(unsigned aShaderProgram)
	{
	...
	void OpenGL_UniformVariableManager::SetUniformInt(const char* aUniformName, unsigned aShaderProgram, const int* aValue) const
	{
		GLuint location = glGetUniformLocation(aShaderProgram, aUniformName);
		glUniform1i(location, *aValue);
	}

	void OpenGL_UniformVariableManager::SetUniformFloat(const char* aUniformName, unsigned aShaderProgram, const float* aValue) const
	{
		GLuint location = glGetUniformLocation(aShaderProgram, aUniformName);
	...
	void OpenGL_UniformVariableManager::SetUniformVec2Float(const char* aUniformName, unsigned aShaderProgram, const Math::Vector2f* aValue) const
	{
		GLuint location = glGetUniformLocation(aShaderProgram, aUniformName);
		glUniform2f(location, aValue->x, aValue->y);
	}

	void OpenGL_UniformVariableManager::SetUniformVec3Float(const char* aUniformName, unsigned aShaderProgram, const Math::Vector3f* aValue) const
	{
		GLuint location = glGetUniformLocation(aShaderProgram, aUniformName);
		glUniform3f(location, aValue->x, aValue->y, aValue->z);
	}

	void OpenGL_UniformVariableManager::SetUniformVec4Float(const char* aUniformName, unsigned aShaderProgram, const Math::Vector4f* aValue) const
	{
		GLuint location = glGetUniformLocation(aShaderProgram, aUniformName);
	...
	void OpenGL_UniformVariableManager::SetUniformMat2x2(const char* aUniformName, unsigned aShaderProgram, const float* aValue) const
	{
		GLuint location = glGetUniformLocation(aShaderProgram, aUniformName);
		glUniform2fv(location, 4, aValue);
	}

	void OpenGL_UniformVariableManager::SetUniformMat3x3(const char* aUniformName, unsigned aShaderProgram, const float* aValue) const
	{
		GLuint location = glGetUniformLocation(aShaderProgram, aUniformName);
		glUniform3fv(location, 9, aValue);
	}

	void OpenGL_UniformVariableManager::SetUniformMat4x4(const char* aUniformName, unsigned aShaderProgram, const float* aValue) const
	{
		GLuint location = glGetUniformLocation(aShaderProgram, aUniformName);
